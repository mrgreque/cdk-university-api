...
export async function adminSecretaryEnsureAuthenticate(request: Request, response: Response, next: NextFunction) {
    ...
    try {
        ...
        if (!isSecretary || isSecretary.sector != 'Administração') {
